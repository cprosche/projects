...
<head>
  ...
  <title>Pain Management Digital Marketing: Marketing for Your Pain Management Practice</title>
...
<body>
  ...
  <div class="container-fluid" id="banner">
    <div class="top-banner">
      ...
      <div class="row">
        <div class="col-xs-6">
          <p class="top-cta"><a href="contact.php">Request An Appointment</a> </p>
        </div>
        <div class="col-xs-6">
      ...
      <div class="center-block" align="center">
        ...
        <p class="tagline" align="center">Marketing for Pain Management Practices</p>
      </div>
    </div>
    <!--top-banner-->
  </div>
  ...
  <nav class="navbar navbar-default navbar-static-top" role="navigation" id="topnavbar">
    ...
    <div class="collapse navbar-collapse" align="center">
      <ul class="nav navbar-nav">
        <li> <a href="marketing-solutions.php"><span class="center-underline">Marketing Solutions</span></a></li>
        <li> <a href="our-work.php"><span class="center-underline">Our Work</span></a></li>
        <li> <a href="blog.php"><span class="center-underline">Growth Tips</span></a></li>
        <li> <a href="about.php"><span class="center-underline">About Us</span></a></li>
        <li> <a href="contact.php"><span class="center-underline">Contact Us</span></a></li>
      </ul>
    </div>
  </nav>
  ...
  <div class="background">
    <div class="container question-responsive" align="center">
      <p class="heading-question">Do You Want To Grow Your Pain Management Practice?</p>
    </div>
  </div>
  <br>
  <br>
  <br>
  <p align="center">We are experts at helping Pain Physicians get more patients<br>through the following marketing efforts:</p>
  <br>
  <br>
  <br>
      ...
      <div class="row">
        <div align="center" class="col-sm-4 center-block">
          <div style="max-width: 260px">
            ...
            <p class="learn-more"><a href="dentist-web-design.php">Learn more about web design</a>&nbsp;<span class="glyphicon glyphicon-chevron-right"></span></p>
        ...
        <div align="center" class="col-sm-4 center-block">
          <div style="max-width: 260px">
            ...
            <p class="learn-more"><a href="ppc-for-dentists.php">Learn more about AdWords</a>&nbsp;<span class="glyphicon glyphicon-chevron-right"></span></p>
          </div>
        </div>
        ...
        <div align="center" class="col-sm-4 center-block">
          <div style="max-width: 260px">
            ...
            <p class="learn-more"><a href="seo-for-dentists.php">Learn more about SEO</a>&nbsp;<span class="glyphicon glyphicon-chevron-right"></span></p>
          </div>
        </div>
      </div>
      <br><br>
      <div class="row">
        <div align="center" class="col-sm-4 center-block service">
          ...
          <div style="max-width: 260px">
            ...
            <p class="learn-more"><a href="content-marketing.php">Learn more about content writing</a>&nbsp;<span class="glyphicon glyphicon-chevron-right"></span></p>
          </div>
        </div>
        <div align="center" class="col-sm-4 center-block service">
          ...
          <div style="max-width: 260px">
            ...
            <p class="learn-more"><a href="online-advertising.php">Learn more about online ads</a>&nbsp;<span class="glyphicon glyphicon-chevron-right"></span></p>
          </div>
        </div>
        <div align="center" class="col-sm-4 center-block service">
          <div style="max-width: 260px">
            ...
            <p class="learn-more"><a href="social-media.php">Learn more about social media</a>&nbsp;<span class="glyphicon glyphicon-chevron-right"></span></p>
          </div>
        </div>
      </div>
      <br>
    ...
    <div class="row">
      <div class="container-fluid" style="max-width: 450px">
        <div class="col-sm-12 blog1" align="center">
          <a href="lead-generation.php"><img src="images/blog-image.jpg" class="img-responsive" alt="to-edit-this" /></a>
          <br>
          <h4 class="blog-title"><a href="lead-generation.php">7 Lead Generation Tips for Dentist Websites</a></h4>
          ...
          <br>
          <a class="read-more" href="lead-generation.php">Read Article <span class="glyphicon glyphicon-chevron-right"></span></a><br><br><br>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="footer-cta" align="center">
    ...
    <div class="col-sm-6" align="center">
      <p class="footer-buttons"><a href="contact.php">Request An Appointment</a></p>
    </div>
  </div>

  <footer>
    <div class="footer-links" align="center">
      <a href="marketing-solutions.php">Dentist Marketing Solutions</a>
      <a href="our-work.php">Our Work</a>
      <a href="blog.php">Growth Tips</a>
    ...
    <div class="policy-links" align="center">
      ...
      <a href="terms.php" rel="nofollow">Terms &amp; Conditions</a> &nbsp;&nbsp;&nbsp;
    </div>
    <br>
    <p align="center" id="copyright">&copy; painmanagementdigitalmarketing.com</p>
  </footer>

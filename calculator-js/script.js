...
Name: Cade Rosche
Project: Calculator
Notes: would like to change this so that the answer 
moves to the top section when equals is pressed
*/
...
*/
  updateDisplay() {
    ...
    if (this.operation != null) {
      ...
      //console.log("operation is not null");
    } else {
...
//the numberButtons and operationButtons work by looping through all atrributes for button type, assigning click event listeners, and sending the button inner text to calculator class methods on button click

numberButtons.forEach((button) => {
  button.addEventListener("click", () => {
    calculator.appendNumber(button.innerText);
    calculator.updateDisplay();
    //console.log("button event listener is here!");
  });
});
